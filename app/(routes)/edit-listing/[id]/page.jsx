    ...
    <div className="px-10 md:px-30 my-10">
      ...
      <Formik
        initialValues={{
          ...
          // profileName: user?.fullName || "Unknown user",
          profileImage: user?.imageUrl,
          fullName: user?.fullName,
        }}
        onSubmit={(values) => {
          // console.log("giiiiiiiii",user);
              ...
              <div className="p-8 rounded-lg shadow-md grid gap-7 mt-6">
                  ...
                  <div className="flex flex-col gap-2">
                    ...
                    >
                      ...
                      <SelectContent>
                        ...
                        <SelectItem value="town">Town House</SelectItem>
                ...
                <div>
                  ...
                  <FileUpload
                    ...
                    imageList={listing?.["listing-images"]}
                  />
                </div>
